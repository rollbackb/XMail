...
<tr>
    ...
    <td><span class="person">
    	<s:if test='#alias!=null&&#alias!=""'>"${alias}"<%name="\""+pageContext.getAttribute("alias")+"\"&lt;"+user.getName()+"@onofor.com&gt;";%></s:if>
    		<s:else>"${user.name}"<%name="\""+user.getName()+"\"&lt;"+user.getName()+"@onofor.com&gt;";%></s:else>&lt;${user.name}@onofor.com&gt;
    	</span>
